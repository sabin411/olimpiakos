...
const PolicyPrivacy = () => {
  return (
    <section className='py-4 min-h-screen w-full  px-5 bg-primary-1000'>
      <div className='container-custom h-full'>
        <h1>Privacy Policy for fun olympic</h1>
        <p>
          At fun-olympic, accessible from http://localhost:3000/, one of our
          main priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by fun-olympic and how we use it. If you have additional questions or
          ...
          information that they shared and/or collect in fun-olympic. This
          ...
          the help of the Free Privacy Policy Generator. Consent By using our
          ...
          emails Find and prevent fraud Log Files fun-olympic follows a standard
          ...
          Beacons Like any other website, fun-olympic uses 'cookies'. These
          ...
          information. Google DoubleClick DART Cookie Google is one of a
          ...
          https://policies.google.com/technologies/ads Our Advertising Partners
          ...
          Privacy Policy for each of the advertising partners of fun-olympic.
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on fun-olympic, which are sent
          directly to users' browser. They automatically receive your IP address
          when this occurs. These technologies are used to measure the
          effectiveness of their advertising campaigns and/or to personalize the
          advertising content that you see on websites that you visit. Note that
          fun-olympic has no access to or control over these cookies that are
          used by third-party advertisers. Third Party Privacy Policies
          fun-olympic's Privacy Policy does not apply to other advertisers or
          ...
          activity. fun-olympic does not knowingly collect any Personal
