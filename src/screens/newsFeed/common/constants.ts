export const newsData = [
  ...
  },
  {
    ...
    image:
      'https://images.unsplash.com/photo-1592656094267-764a45160876?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80',
    title:
      'Thankful to have group of lads who understood the bigger picture - Stokes',
    description:
      "Ben Stokes has complimented his teammates, and especially former captain Joe Root, for the smooth transition in England's playing style and team culture. This summer, England have won six out of their seven Tests - the latest of them being a nine-wicket win over South Africa that sealed the series in style.Ben Stokes has complimented his teammates, and especially former captain Joe Root, for the smooth transition in England's playing style and team culture. This summer, England have won six out of their seven Tests - the latest of them being a nine-wicket win over South Africa that sealed the series in style.",
  },
];
