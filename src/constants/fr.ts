...
export const errorMessages = {
  fullNameRequired: "S'il vous plait entrez votre nom entier.",
  fullNameMin: 'Le nom doit comporter au moins 3 caractères.',
  fullNameMax: 'Le nom doit comporter moins de 25 caractères.',
...
// footer constants
export const footer = {
  exploreMoreButton: 'Explore plus',
  description:
    'Regardez vos sports préférés, découvrez des films et séries originaux primés et explorez nos chaînes linéaires thématiques 24h/24 et 7j/7.',
  footerConst: [
    {
      title: 'Jeux',
      links: [
